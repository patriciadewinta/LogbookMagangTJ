      ...
      >
          ...
          <div className="flex flex-1 justify-center">
            <ViewTransition name="logo-tj" default="block">
              <img
                ...
                alt="Logo Tj"
                className="size-[96px] rounded-[10px] object-cover mix-blend-luminosity"
              />
            </ViewTransition>
          </div>
          <button
            ...
            return (
              <Link
                ...
                className={`flex items-center gap-4 rounded-[10px] px-4 py-3 transition-colors ${
                  active ? "bg-[#97a3ff]/60" : "hover:bg-white/10"
                }`}
              >
        ...
        <div className="mt-auto px-[14px] pb-[max(env(safe-area-inset-bottom),20px)]">
          ...
          <div className="mt-4 flex items-center gap-3">
            ...
            >
              <img src="/assets/sidebar-logout.png" alt="" className="size-7 object-contain" />
            </button>
          </div>
        </div>
      </aside>
